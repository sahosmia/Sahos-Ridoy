...
export default function MyWorkItem({ item, index }) {
  ...
  return (
    <div
      className={`w-full lg:col-span-2 rounded-lg shadow-lg  mx-auto flex flex-col gap-10 max-md:max-w-sm overflow-hidden bg-light p-5 lg:p-5 z-10 ${
        index == 2
    ...
    >
      ...
      <div className=" flex-1 pr-10">
        <Link
          href={`portfolio/${slug}`}
          className="pt-4 md:pt-0 text-xl md:text-2xl font-bold text-gray-600 line-clamp-2"
        >
          {title}
        </Link>
