...
export default function TargetItem({ item }) {
  ...
  return (
    <div className="p-5 md:p-8 flex-1 flex flex-col flex-wrap justify-center items-center bg-gray-50 border border-1 border-slate-100  rounded-lg  transition ease-in-out duration-300 shadow-sm">
